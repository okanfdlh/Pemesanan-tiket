...
body {
  ...
  background: -webkit-linear-gradient(to right, #27bee4, #bdc3c7);  /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #27bee4, #bdc3c7); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
...
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-light">Pembayaran</h1>
            <div id="pay-invoice" class="card">
                <div class="card-body">
            <label for="fname">Kartu Pembayaran</label>
            ...
            <hr>
            <form action="includes/pembayaran.inc.php" method="post" 
                novalidate="novalidate" class="needs-validation">
  
                <div class="form-group">
                    <label for="cc-number" class="control-label mb-1">No Kartu</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                ...
                                <div class="input-group-append">
                                    ...
                                    data-content="<div class='text-center one-card'>Kode 3 digit di belakang kartu..<div class='visa-mc-cvc-preview'></div></div>"
