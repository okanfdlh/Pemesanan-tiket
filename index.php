...
body {
	...
	background: #27bee4;  /* fallback for old browsers */
background: -webkit-linear-gradient(to right, #fff, #27bee4);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #fff, #27bee4); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
...
<section class="home" id="home">
    <div class="swiper-container home-slider">
        ...
        <div class="swiper-wrapper wrapper">
            ...
            <div class="swiper-slide slide">
                <div class="content">
                    <span>Garuda Air</span>
                    <h3>Travely Safely</h3>
                    <p>We Understand You<br>#BecauseYouMatter.</p>
                    <a href="#menu" class="btn">pesan sekarang</a>
                </div>
                <div class="image">
                    <img src="assets/images/garuda1.jpeg" alt="">
                </div>
            </div>
            ...
            <div class="swiper-slide slide">
                <div class="content">
                    <span>Garuda Air</span>
                    <h3>Garuda Air</h3>
                    <p>Terbang kemana saja pakai garuda.</p>
                    <a href="#menu" class="btn">pesan sekarang</a>
                </div>
                <div class="image">
                    <img src="assets/images/garuda2.jpg" alt="">
                </div>
            </div>
            ...
            <div class="swiper-slide slide">
                <div class="content">
                    <span>Garuda Air</span>
                    <h3>cabin crew</h3>
                    <p>Vaccinated pilot and crew.</p>
                    <a href="#menu" class="btn">pesan sekarang</a>
                </div>
                <div class="image">
                    <img src="assets/images/garuda3.jpg" alt="">
                </div>
            </div>
	...
	<div class="main-agileinfo">
		<h1 class="text-light brand mt-2">
			<img src="assets/images/logoOkan.png" 
				height="105px" width="105px" alt="">				
		Pemesanan Tiket Penerbangan Online</h1>
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Cari Jadwal</span></li>
				</ul>	
				...
				<div class="resp-tabs-container">
					...
					<div class="tab-1 resp-tab-content oneway">
						<form action="jadwal.php" method="post">
							...
							<div class="from">
								<h3 style="color: rgba(255, 255, 255, 0.767);">Asal Kota</h3>								
								<?php
							...
							<div class="numofppl">
								<div class="adults">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Penumpang</h3>
									<div class="quantity"> 
							...
							<div class="clear"></div>
							<input type="submit" value="Cari Jadwal" name="search_but">
						</form>																				
	</div>
	</div>
	</div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3>contact info</h3>
            <a href="#">+62 888-090-6969</a>
            <a href="#">+62 825-737-6939</a>
            <a href="#">garudaair@gmail.co.id</a>
        </div>

        <div class="box">
            <h3>follow us</h3>
            <a href="#">facebook</a>
            <a href="https://www.instagram.com/okanfdlh/?next=%2F">instagram</a>
            <a href="#">TikTok</a>
        </div>
