...
body {
  ...
  background: -webkit-linear-gradient(to right, #2c3e50, #27bee4);  /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #2c3e50, #27bee4); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
                      ...
                      if($row_f = mysqli_fetch_assoc($result_f)) {
                            ...
                            <div class="row ">                                                     
                                <div class="col">
                                    <h2 class="text-secondary mb-0 brand">
                                        Pemesanan tiket Penerbangan Online</h2> 
                                </div>
                                <div class="col">
                        ...
                        <div class="col-3 pl-0" style="background-color:#376b8d !important;
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12">                                    
                                    <img src="assets/images/logoOkan.png" class="mx-auto d-block"
                                    height="200px" width="200px" alt="">
                                </div>                                
                            </div>
                            <div class="row">
                                <h3 class="text-light2 text-center mt-2 mb-0">
                                &nbsp Terima kasih telah memilih kami. </br> </br>
                                    Harap berada di gerbang saat boarding</h3>   
                            </div>                            
                        </div>   
