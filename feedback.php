...
body {
  ...
  background: -webkit-linear-gradient(to right, #2c3e50, #0000FF);  /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #2c3e50, #0000FF); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
