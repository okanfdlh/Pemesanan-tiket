...
<div class="container mt-0">
  <div class="row">
    ...
    ?>
      ...
      <h1 class="text-secondary text-center">TAMBAHKAN PENERBANGAN</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row mb-4">
          <div class="col-md-3 p-0">
            <h5 class="mb-0 form-name">BERANGKAT</h5>
          </div>
          <div class="col"> 
        ...
        <div class="form-row mb-4">
        <div class="col-md-3 ">
            <h5 class="form-name mb-0">TIBA</h5>
          </div>          
          <div class="col">
        ...
        <button name="flight_but" type="submit" 
          ...
          <i class="fa fa-lg fa-arrow-right"></i> Tambah
          </div>
        </button>
      </form>
    </div>
