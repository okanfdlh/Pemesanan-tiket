...
background: -webkit-linear-gradient(to left, #29323c, #27bee4);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to left, #29323c, #27bee4); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
