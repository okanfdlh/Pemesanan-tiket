...
.dashbord-red .detail-section{
      ...
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Penerbangan Hari ini</a>
              <a class="dropdown-item" href="#issue">Masalah penerbangan hari ini</a>
              <a class="dropdown-item" href="#dep">Penerbangan berangkat hari ini</a>
              <a class="dropdown-item" href="#arr">Penerbangan tiba hari ini</a>
            </div>
          </div>        
        <p class="text-secondary">Penerbangan Hari ini</p>
        <table class="table-sm table table-hover">
          <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
              <th scope="col">Mendarat</th>
    ...
    <div class="card" id="issue">
      <div class="card-body">
        ...
        <p class="text-secondary">Masalah penerbangan hari ini</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
    ...
    <div class="card" id="dep">
      <div class="card-body">
        ...
        <p class=" text-secondary">Penerbangan berangkat hari ini</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class=" text-secondary">Penerbangan tiba hari ini</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
